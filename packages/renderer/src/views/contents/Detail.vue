      ...
      <div class="layui-col-md8 content detail">
        <div class="fly-panel detail-box">
          ...
          <div class="fly-detail-info">
            ...
            <span class="layui-badge" style="background-color: #999;" v-if="state.page.isEnd === '0'">未结</span>
            <span class="layui-badge" style="background-color: #5FB878;" v-else>已结</span>

            <span class="layui-badge layui-bg-black" v-show="state.page.isTop === '1'">置顶</span>
            <span class="layui-badge" :class="tag.class" v-for="(tag,index) in state.page.tags" :key="'tags' + index">{{tag.name}}</span>
            ...
            <div>
              <div class="fly-admin-box" data-id="123">
                ...
                <span class="layui-btn layui-btn-xs jie-admin" type="set" field="stick" rank="1" v-if="state.page.isTop === '0'">置顶</span>
                <span class="layui-btn layui-btn-xs jie-admin" type="set" field="stick" rank="0" style="background-color:#ccc;" v-else>取消置顶</span>
          ...
          <div class="detail-about">
            ...
            <div class="fly-detail-user">
              <a href="../user/home.html" class="fly-link">
                ...
                <i class="layui-badge fly-badge-vip mr1" v-if="state.page.uid && state.page.uid.isVip !== '0'? state.page.uid.isVip : false">VIP{{state.page.uid.isVip}}</i>
              </a>
              <span>{{formatDate(state.page.created)}}</span>
            </div>
              ...
              <Form ref="observer" v-slot="{ validate,errors }">
                ...
                <div class="layui-form-item">
                  <div class="layui-row">
                    ...
                    <div class>
                      <span class="svg" style="color: #c00;" @click="getCaptcha()" v-html="codeState.svg"></span>
                    </div>
                  </div>
